...
write.csv(ex_dist, paste0(outputdir,"markers_with_genes_DNA_SW.csv"), row.names = F)

write.csv(ex_dist, paste0(outputdir,"markers_with_genes_RNA_SW.csv"), row.names = F)
