...
run_pretty_region("./body_weight/", "body_weight_with_covar_body_length", method="fdr")
...
run_pretty_region("./spermatids_per_perimeter/", "spermatids_per_perimeter", method="fdr")
